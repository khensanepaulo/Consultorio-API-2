...
public class MedicoService {
    ...
    public Optional<Medico> findById(Long id){return this.medicoRepository.findById(id);}
    ...
    public Page<Medico> listAll(Pageable pageable){return this.medicoRepository.findAll(pageable);}

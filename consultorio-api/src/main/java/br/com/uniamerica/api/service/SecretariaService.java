...
public class SecretariaService {
     ...
     * @return
     */
    public Page<Secretaria> ListAll(Pageable pageable){return this.secretariaRepository.findAll(pageable);}
     ...
     */
    @Transactional
    public void insert(Secretaria secretaria) {this.secretariaRepository.save(secretaria);}
